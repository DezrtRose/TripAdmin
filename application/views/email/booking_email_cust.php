<body style="margin: 0; background: none repeat scroll 0% 0% rgb(222, 222, 222); padding: 10px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; line-height: 2">
    <div style="background: none repeat scroll 0% 0% rgb(255, 255, 255); margin: 15px; padding: 15px;">
        ...
        <p style="margin: 0;">Dear <?php echo ucwords(strtolower($first_name)).' '.ucwords(strtolower($last_name)) ?>,</p>
        <p>
            Thank you for your interest in <strong style="color: rgb(74, 150, 219)"><?php echo $trip . ' trip' ?></strong>. We have received your information and will be in
