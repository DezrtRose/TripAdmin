...
<section id="special-trips" class="top-deals">
    <div class="container">
        <div class="row">
            <h1 class="text-center"><strong>ALL TRIP</strong></h1>
            <div id='top-deals'>
                <?php foreach($trip as $occasion_trip) : ?>
		<div class="item" style="width: ">
				   ...
				   <p>
                                ...
                                <a href="<?php echo base_url('trips/'.$occasion_trip['slug']) ?>">
                                    <?php
                                    $img = $this->common_model->get_where('tbl_trip_slider', array('trip_id' => $occasion_trip['id']), '', 1);
